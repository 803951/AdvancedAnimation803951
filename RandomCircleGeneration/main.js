...
function assignSource(pic){
  switch(pic){
    ...
    case 4:
      //sunset
      img.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiAkQohukz4FqQzu0wnfgfbJlXa0eoF_-fsQ&usqp=CAU";
      break;
    case 5:
      //fireworks
      img.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Tybee_island_georgia_july_4_fireworks.jpg/220px-Tybee_island_georgia_july_4_fireworks.jpg";
      break;
    default:
      //flower
